...
2. Dans Supabase, allez dans **Authentication > Users > Add user** et créez l’utilisateur `rakotonandrasanaamede5@gmail.com` avec le mot de passe administrateur de votre choix. Confirmez l’utilisateur si nécessaire. Le mot `admin` saisi dans l’application est automatiquement converti en cette adresse.
